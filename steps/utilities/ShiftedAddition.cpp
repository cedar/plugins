...
// LOCAL INCLUDES
#include "steps/utilities/ShiftedAddition.h"
...
cedar::proc::steps::ShiftedAddition::ShiftedAddition()
:
...
void cedar::proc::steps::ShiftedAddition::recompute()
{
...
void cedar::proc::steps::ShiftedAddition::inputConnectionChanged(const std::string&)
{
  reconfigure();
}

void cedar::proc::steps::ShiftedAddition::reconfigure()
{
  unsigned int orientation_size = _mOrientationSize->getValue();
...
void cedar::proc::steps::ShiftedAddition::compute(const cedar::proc::Arguments&)
{
  this->recompute();
}
