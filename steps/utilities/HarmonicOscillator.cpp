...
#include "steps/utilities/HarmonicOscillator.h"
#include <cedar/auxiliaries/MatData.h>
#include "cedar/processing/Arguments.h"
#include "cedar/units/Time.h"
#include "cedar/units/prefixes.h"

cedar::proc::steps::HarmonicOscillator::HarmonicOscillator()
    :
...
void cedar::proc::steps::HarmonicOscillator::eulerStep(const cedar::unit::Time& time)
{
...
cedar::aux::MatDataPtr cedar::proc::steps::HarmonicOscillator::getCurrentPosition()
{
  return this->_mPData;
}

cedar::aux::MatDataPtr cedar::proc::steps::HarmonicOscillator::getCurrentVelocity()
{
  return this->_mPDotData;
}

void cedar::proc::steps::HarmonicOscillator::setK(unsigned int dimension, double k)
{
...
void cedar::proc::steps::HarmonicOscillator::setB(unsigned int dimension, double b)
{
...
void cedar::proc::steps::HarmonicOscillator::setK(double k)
{
  for (unsigned int d = 0; d < _mDimensionality->getValue(); d++)
  {
    _K->setValue(d, k);
...
void cedar::proc::steps::HarmonicOscillator::setB(double b)
{
  for (unsigned int d = 0; d < _mDimensionality->getValue(); d++)
  {
    _B->setValue(d, b);
...
std::vector<double> cedar::proc::steps::HarmonicOscillator::getK()
{
  return _K->getValue();
}

std::vector<double> cedar::proc::steps::HarmonicOscillator::getB()
{
  return _B->getValue();
}

void cedar::proc::steps::HarmonicOscillator::setInitPos(float dimension, float value)
{
  _initPos->setValue(dimension, value);
}

void cedar::proc::steps::HarmonicOscillator::updateMatrixSize()
{
...
void cedar::proc::steps::HarmonicOscillator::updateDimensionality()
{
...
void cedar::proc::steps::HarmonicOscillator::updateDampingB()
{
...
void cedar::proc::steps::HarmonicOscillator::updateDampingK()
{
...
void cedar::proc::steps::HarmonicOscillator::reset()
{
  cv::Mat& _mPDot = _mPDotData->getData();
  cv::Mat& _mP = _mPData->getData();
  _mPDot = cv::Mat::zeros(_mDimensionality->getValue(), 1, CV_32F);
