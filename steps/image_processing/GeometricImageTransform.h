...
========================================================================================================================
    ...
    File:        GeometricImageTransform.h

    Maintainer:  Oliver Lomp
    Email:       oliver.lomp@ini.ruhr-uni-bochum.de
    Date:        2016 03 09

    Description: Header file for the class cedar::proc::steps::GeometricImageTransform.

    Credits:

======================================================================================================================*/

#ifndef CEDAR_PROC_STEPS_GEOMETRIC_IMAGE_TRANSFORM_H
#define CEDAR_PROC_STEPS_GEOMETRIC_IMAGE_TRANSFORM_H
...
#include "steps/image_processing/GeometricImageTransform.fwd.h"
...
/*!
 */
class cedar::proc::steps::GeometricImageTransform : public cedar::proc::Step
{
  Q_OBJECT
...
}; // class cedar::proc::steps::GeometricImageTransform

#endif // CEDAR_PROC_STEPS_GEOMETRIC_IMAGE_TRANSFORM_H
