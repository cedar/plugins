...
#ifndef CEDAR_PROC_STEPS_LINEAR_SPATIAL_PATTERN_H
#define CEDAR_PROC_STEPS_LINEAR_SPATIAL_PATTERN_H

// LOCAL INCLUDES
#include "steps/sources/LinearSpatialPattern.fwd.h"
 ...
 */
class cedar::proc::steps::LinearSpatialPattern : public cedar::proc::Step
{
  //--------------------------------------------------------------------------------------------------------------------
  // macros
  //--------------------------------------------------------------------------------------------------------------------
