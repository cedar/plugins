...
#ifndef CEDAR_DYN_SERIAL_ORDER_RECRUITING_H
#define CEDAR_DYN_SERIAL_ORDER_RECRUITING_H
 ...
 */
class cedar::dyn::SerialOrderRecruiting : public cedar::dyn::Dynamics
{
  //--------------------------------------------------------------------------------------------------------------------
  // macros
  //--------------------------------------------------------------------------------------------------------------------
...
protected:
  ...
  cedar::aux::BoolParameterPtr _mUseDynamicExtension;
}; // class cedar::dyn::SerialOrderRecruiting

#endif // CEDAR_DYN_SERIAL_ORDER_RECRUITING_H
